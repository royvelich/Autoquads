...
private:
	...
	*/
	...
	void GetOrderedProjectedVertices(const std::vector<std::pair<RDS::VertexIndex, Eigen::Vector3d>>& input_pairs, RDS::FaceIndex face_index, std::vector<std::pair<RDS::VertexIndex, Eigen::Vector3d>>& output_pairs);
